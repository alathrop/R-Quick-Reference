From Stanford Introduction to Statistical Learning course, Chapter 6
R video session @ http://bit.ly/21k5WAF | Videos 11-14
...
plot(fit.lasso,xvar="dev",label=TRUE) # amount of deviance explained
